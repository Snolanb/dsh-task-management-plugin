...
import { WorkerDispatcher, createHeadlessProcessLauncher } from './dispatcher.js'
...
export function apply(ctx, config = {}) {
  ...
  const api = Object.freeze({
    ...
    createDispatcher: (options = {}) => new WorkerDispatcher({
      ...
      launcher: options.launcher ?? createHeadlessProcessLauncher(options.launcherOptions),
