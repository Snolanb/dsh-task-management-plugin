...
const CREATE_SQL = String.raw`INSERT INTO tasks (
  id, title, description, status, priority, parent_id, workspace, repo, branch,
  ...
  update(id, patch, options = {}) {
    ...
    return this._write(db => {
      ...
      const allowed = {
        ...
        acceptance_criteria: 'acceptance_criteria', task_type: 'task_type', attempts: 'attempts', max_attempts: 'max_attempts',
